...
import it.csi.nivola.nivolasp.integration.rest.model.service.GetAWSResponseSchema;


@Component("it.csi.nivola.nivolasp.integration.rest.api.service.AwsApi")
public class AwsApi {
    ...
    /**
     * Get AWS Wrapper Call this api to get a specific aws wrapper
     * 
     * <p><b>200</b> - success
     ...
     * @return GetAWSResponseSchema
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public GetAWSResponseSchema v10NwsWrapperawsGet() throws RestClientException {
        return v10NwsWrapperawsGetWithHttpInfo().getBody();
    }
     ...
     * <p><b>500</b> - The operation failed. An unexpected exception occurred while executing the operation. The response-body contains details about the error.
     * <p><b>0</b> - Defualt error syntax
     * @return ResponseEntity&lt;GetAWSResponseSchema&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<GetAWSResponseSchema> v10NwsWrapperawsGetWithHttpInfo() throws RestClientException {
        Object postBody = null;
        
        String path = UriComponentsBuilder.fromPath("/v1.0/nws/wrapperaws").build().toUriString();
        ...
        ParameterizedTypeReference<GetAWSResponseSchema> returnType = new ParameterizedTypeReference<GetAWSResponseSchema>() {};
