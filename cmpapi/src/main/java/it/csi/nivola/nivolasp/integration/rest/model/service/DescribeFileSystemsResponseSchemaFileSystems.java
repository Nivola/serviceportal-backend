...
/**
 * DescribeFileSystemsResponseSchemaFileSystems
 */

public class DescribeFileSystemsResponseSchemaFileSystems {
  ...
  public DescribeFileSystemsResponseSchemaFileSystems creationTime(LocalDateTime creationTime) {
  ...
  **/
  ...
  public DescribeFileSystemsResponseSchemaFileSystems creationToken(String creationToken) {
  ...
  **/
  ...
  public DescribeFileSystemsResponseSchemaFileSystems encrypted(Boolean encrypted) {
  ...
  **/
  ...
  public DescribeFileSystemsResponseSchemaFileSystems fileSystemId(String fileSystemId) {
  ...
  **/
  ...
  public DescribeFileSystemsResponseSchemaFileSystems kmsKeyId(String kmsKeyId) {
  ...
  **/
  ...
  public DescribeFileSystemsResponseSchemaFileSystems lifeCycleState(LifeCycleStateEnum lifeCycleState) {
  ...
  **/
  ...
  public DescribeFileSystemsResponseSchemaFileSystems name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public DescribeFileSystemsResponseSchemaFileSystems numberOfMountTargets(Integer numberOfMountTargets) {
  ...
  **/
  ...
  public DescribeFileSystemsResponseSchemaFileSystems ownerId(String ownerId) {
  ...
  **/
  ...
  public DescribeFileSystemsResponseSchemaFileSystems performanceMode(PerformanceModeEnum performanceMode) {
  ...
  **/
  ...
  public DescribeFileSystemsResponseSchemaFileSystems provisionedThroughputInMibps(Integer provisionedThroughputInMibps) {
  ...
  **/
  ...
  public DescribeFileSystemsResponseSchemaFileSystems sizeInBytes(DescribeFileSystemsResponseSchemaSizeInBytes sizeInBytes) {
  ...
  **/
  ...
  public DescribeFileSystemsResponseSchemaFileSystems throughputMode(ThroughputModeEnum throughputMode) {
  ...
  **/
  ...
  public DescribeFileSystemsResponseSchemaFileSystems nvlCapabilities(List<String> nvlCapabilities) {
    this.nvlCapabilities = nvlCapabilities;
    return this;
  }

  public DescribeFileSystemsResponseSchemaFileSystems addNvlCapabilitiesItem(String nvlCapabilitiesItem) {
  ...
  **/
  ...
  public DescribeFileSystemsResponseSchemaFileSystems nvlOwnerAlias(String nvlOwnerAlias) {
  ...
  **/
  ...
  public DescribeFileSystemsResponseSchemaFileSystems nvlStateReason(DeleteDBInstancesApiResponseSchemaDeleteDBInstanceResponseDeleteDBInstanceResultDBInstanceNvlstateReason nvlStateReason) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DescribeFileSystemsResponseSchemaFileSystems describeFileSystemsResponseSchemaFileSystems = (DescribeFileSystemsResponseSchemaFileSystems) o;
    return Objects.equals(this.creationTime, describeFileSystemsResponseSchemaFileSystems.creationTime) &&
        Objects.equals(this.creationToken, describeFileSystemsResponseSchemaFileSystems.creationToken) &&
        Objects.equals(this.encrypted, describeFileSystemsResponseSchemaFileSystems.encrypted) &&
        Objects.equals(this.fileSystemId, describeFileSystemsResponseSchemaFileSystems.fileSystemId) &&
        Objects.equals(this.kmsKeyId, describeFileSystemsResponseSchemaFileSystems.kmsKeyId) &&
        Objects.equals(this.lifeCycleState, describeFileSystemsResponseSchemaFileSystems.lifeCycleState) &&
        Objects.equals(this.name, describeFileSystemsResponseSchemaFileSystems.name) &&
        Objects.equals(this.numberOfMountTargets, describeFileSystemsResponseSchemaFileSystems.numberOfMountTargets) &&
        Objects.equals(this.ownerId, describeFileSystemsResponseSchemaFileSystems.ownerId) &&
        Objects.equals(this.performanceMode, describeFileSystemsResponseSchemaFileSystems.performanceMode) &&
        Objects.equals(this.provisionedThroughputInMibps, describeFileSystemsResponseSchemaFileSystems.provisionedThroughputInMibps) &&
        Objects.equals(this.sizeInBytes, describeFileSystemsResponseSchemaFileSystems.sizeInBytes) &&
        Objects.equals(this.throughputMode, describeFileSystemsResponseSchemaFileSystems.throughputMode) &&
        Objects.equals(this.nvlCapabilities, describeFileSystemsResponseSchemaFileSystems.nvlCapabilities) &&
        Objects.equals(this.nvlOwnerAlias, describeFileSystemsResponseSchemaFileSystems.nvlOwnerAlias) &&
        Objects.equals(this.nvlStateReason, describeFileSystemsResponseSchemaFileSystems.nvlStateReason);
  }

  @Override
  public int hashCode() {
    return Objects.hash(creationTime, creationToken, encrypted, fileSystemId, kmsKeyId, lifeCycleState, name, numberOfMountTargets, ownerId, performanceMode, provisionedThroughputInMibps, sizeInBytes, throughputMode, nvlCapabilities, nvlOwnerAlias, nvlStateReason);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeFileSystemsResponseSchemaFileSystems {\n");
