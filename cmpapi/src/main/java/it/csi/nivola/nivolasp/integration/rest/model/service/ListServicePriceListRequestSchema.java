...
/**
 * ListServicePriceListRequestSchema
 */

public class ListServicePriceListRequestSchema {
  @JsonProperty("active")
  ...
  public ListServicePriceListRequestSchema active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  **/
  ...
  public ListServicePriceListRequestSchema field(FieldEnum field) {
    this.field = field;
    return this;
  }
  ...
  **/
  ...
  public ListServicePriceListRequestSchema filterCreationDateStart(LocalDateTime filterCreationDateStart) {
  ...
  **/
  ...
  public ListServicePriceListRequestSchema filterCreationDateStop(LocalDateTime filterCreationDateStop) {
  ...
  **/
  ...
  public ListServicePriceListRequestSchema filterExpired(Boolean filterExpired) {
  ...
  **/
  ...
  public ListServicePriceListRequestSchema filterExpiryDateStart(LocalDateTime filterExpiryDateStart) {
  ...
  **/
  ...
  public ListServicePriceListRequestSchema filterExpiryDateStop(LocalDateTime filterExpiryDateStop) {
  ...
  **/
  ...
  public ListServicePriceListRequestSchema filterModificationDateStart(LocalDateTime filterModificationDateStart) {
  ...
  **/
  ...
  public ListServicePriceListRequestSchema filterModificationDateStop(LocalDateTime filterModificationDateStop) {
  ...
  **/
  ...
  public ListServicePriceListRequestSchema flagDefault(Boolean flagDefault) {
  ...
  **/
  ...
  public ListServicePriceListRequestSchema name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public ListServicePriceListRequestSchema objid(String objid) {
    this.objid = objid;
    return this;
  }
  ...
  **/
  ...
  public ListServicePriceListRequestSchema order(OrderEnum order) {
    this.order = order;
    return this;
  }
  ...
  **/
  ...
  public ListServicePriceListRequestSchema page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  **/
  ...
  public ListServicePriceListRequestSchema size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public ListServicePriceListRequestSchema version(String version) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ListServicePriceListRequestSchema listServicePriceListRequestSchema = (ListServicePriceListRequestSchema) o;
    return Objects.equals(this.active, listServicePriceListRequestSchema.active) &&
        Objects.equals(this.field, listServicePriceListRequestSchema.field) &&
        Objects.equals(this.filterCreationDateStart, listServicePriceListRequestSchema.filterCreationDateStart) &&
        Objects.equals(this.filterCreationDateStop, listServicePriceListRequestSchema.filterCreationDateStop) &&
        Objects.equals(this.filterExpired, listServicePriceListRequestSchema.filterExpired) &&
        Objects.equals(this.filterExpiryDateStart, listServicePriceListRequestSchema.filterExpiryDateStart) &&
        Objects.equals(this.filterExpiryDateStop, listServicePriceListRequestSchema.filterExpiryDateStop) &&
        Objects.equals(this.filterModificationDateStart, listServicePriceListRequestSchema.filterModificationDateStart) &&
        Objects.equals(this.filterModificationDateStop, listServicePriceListRequestSchema.filterModificationDateStop) &&
        Objects.equals(this.flagDefault, listServicePriceListRequestSchema.flagDefault) &&
        Objects.equals(this.name, listServicePriceListRequestSchema.name) &&
        Objects.equals(this.objid, listServicePriceListRequestSchema.objid) &&
        Objects.equals(this.order, listServicePriceListRequestSchema.order) &&
        Objects.equals(this.page, listServicePriceListRequestSchema.page) &&
        Objects.equals(this.size, listServicePriceListRequestSchema.size) &&
        Objects.equals(this.version, listServicePriceListRequestSchema.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(active, field, filterCreationDateStart, filterCreationDateStop, filterExpired, filterExpiryDateStart, filterExpiryDateStop, filterModificationDateStart, filterModificationDateStop, flagDefault, name, objid, order, page, size, version);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListServicePriceListRequestSchema {\n");
