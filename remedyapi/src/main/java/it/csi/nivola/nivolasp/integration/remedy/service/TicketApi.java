...
@Component("it.csi.nivola.nivolasp.integration.remedy.service.TicketApi")
public class TicketApi {
    ...
    public InfoNotaWLog addWorkinfoTicket(String xRequestID, String xForwardedFor, String ticketId, String riepilogo, String tipologia, String note, String nomeAllegato1, File customKey) throws RestClientException {
        ...
        if (customKey != null)
            formParams.add(nomeAllegato1, new FileSystemResource(customKey));
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public Ticket createTicket(String xRequestID, String xForwardedFor, Ticket ticket) throws RestClientException {
        Object postBody = ticket;
        
        // verify the required parameter 'xRequestID' is set
        if (xRequestID == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'xRequestID' when calling createTicket");
        }
        
        // verify the required parameter 'xForwardedFor' is set
        if (xForwardedFor == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'xForwardedFor' when calling createTicket");
        }
        
        // verify the required parameter 'ticket' is set
        if (ticket == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'ticket' when calling createTicket");
        }
        
        String path = UriComponentsBuilder.fromPath("/tickets").build().toUriString();
        ...
        ParameterizedTypeReference<Ticket> returnType = new ParameterizedTypeReference<Ticket>() {};
