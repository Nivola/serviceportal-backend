 ...
 *
 */
public class InfocostoDTO implements Serializable {
	...
	public ListinoDTO getSpDListino() {
		return spDListino;
	}

	public void setSpDListino(ListinoDTO spDListino) {
